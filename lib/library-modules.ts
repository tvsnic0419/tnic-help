...
export const libraryModules: LibraryModule[] = [
  ...
  },
  {
    ...
    category: 'compounds',
    title: 'Berberine',
    tagline: 'AMPK activator & microbiome modulator — accessible metformin alternative',
    summary:
      'Plant-derived isoquinoline alkaloid that inhibits mitochondrial complex I to activate AMPK — the same primary mechanism as metformin. OTC-accessible with multiple Chinese RCTs showing glucose-lowering comparable to metformin, plus Akkermansia-boosting microbiome effects. Tier A for metabolic outcomes; longevity endpoint data does not yet exist.',
    evidenceTier: 'A',
    relatedHallmarkIds: ['nutrient', 'inflammation', 'dysbiosis', 'mito'],
    compoundId: 'berberine',
    relatedSynergySlugs: [],
    outline: [
      'Overview & AMPK mechanism',
      'Berberine vs metformin comparison',
      'Evidence summary (RCTs, meta-analyses)',
      'Dosing protocol & titration',
      'Microbiome effects (Akkermansia)',
      'Drug interaction checklist',
      'Monitoring: fasting glucose, hs-CRP, B12',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'berberine',
  },
  {
    ...
    tagline: 'Mitochondrial electron carrier — statin-depleted, age-declined',
    summary:
      'Essential cofactor at three ETC complexes, declining ~50% by age 70. Ubiquinol form achieves 3-8x bioavailability over ubiquinone. Meta-analysis of 17 RCTs confirms hs-CRP and IL-6 reduction. Critical for statin users.',
    evidenceTier: 'B',
    ...
    outline: [
      ...
      'Evidence summary (meta-analysis, statin depletion)',
      'Dosing protocol & form guidance',
      'Monitoring: hs-CRP, CoQ10 blood levels',
      'Safety & interactions',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'coq10',
  },
  {
    ...
    category: 'compounds',
    title: 'Fisetin',
    tagline: 'Senolytic flavonoid — pulse-dose clearance of senescent cells',
    summary:
      'Most potent senolytic flavonoid identified. Mayo Clinic pilot RCT confirmed reduced p16/p21 senescence burden with pulse-dose protocol (20 mg/kg x 2 days/month). Not a daily supplement — pulse dosing is the evidence-based approach.',
    evidenceTier: 'B',
    relatedHallmarkIds: ['senescence', 'inflammation', 'communication'],
    compoundId: 'fisetin',
    relatedSynergySlugs: [],
    outline: [
      'Overview & senolytic mechanism',
      'Pulse-dose vs daily — why protocol matters',
      'Evidence summary (Mayo Clinic pilot)',
      'Dosing protocol & scheduling',
      'Monitoring: senescence markers',
      'Safety & interactions',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'fisetin',
  },
  {
    ...
    tagline: 'Pro-resolving mediators — active inflammation resolution',
    summary:
      'EPA and DHA generate specialized pro-resolving mediators (SPMs) that actively resolve inflammation. REDUCE-IT (n=8,179) showed 25% CV event reduction with 4 g/day EPA. Dose 2-4 g combined EPA+DHA daily with fat-containing meal.',
    evidenceTier: 'A',
    relatedHallmarkIds: ['inflammation', 'telomeres', 'communication', 'dysbiosis'],
    compoundId: 'omega3',
    relatedSynergySlugs: [],
    outline: [
      'Overview & SPM mechanism',
      'EPA vs DHA — different roles',
      'Evidence summary (REDUCE-IT, meta-analyses)',
      'Dosing protocol & omega-3 index',
      'Monitoring: omega-3 index, hs-CRP, triglycerides',
      'Safety & interactions',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'omega3',
  },
  {
    ...
    category: 'compounds',
    title: 'Pterostilbene',
    tagline: 'Methylated resveratrol analog — 4x oral bioavailability',
    summary:
      'Dimethylated resveratrol derivative with ~4x human oral bioavailability via increased lipophilicity. Activates SIRT1/AMPK through the same pathway as resveratrol. Safety confirmed by Kapetanovic 2011; longevity outcomes extrapolated from shared mechanism.',
    evidenceTier: 'B',
    relatedHallmarkIds: ['mito', 'epigenetic', 'inflammation', 'senescence'],
    compoundId: 'pterostilbene',
    relatedSynergySlugs: ['nmn-resveratrol-sirt1'],
    outline: [
      'Overview & resveratrol comparison',
      'Mechanism: SIRT1/AMPK activation',
      'Evidence summary (Kapetanovic PK)',
      'Dosing protocol & NMN pairing',
      'Monitoring',
      'Buyer guide & red flags',
    ],
  ...
  },
  {
    ...
    category: 'compounds',
    title: 'Spermidine',
    tagline: 'Dietary polyamine — EP300-mediated autophagy induction',
    summary:
      'Natural polyamine that induces autophagy via EP300 acetyltransferase inhibition. Madeo 2021 Cell RCT improved memory in older adults. Epidemiological data links dietary intake to longevity. 1-6 mg supplemental or wheat-germ dietary sources.',
    evidenceTier: 'B',
    relatedHallmarkIds: ['autophagy', 'senescence', 'epigenetic'],
    compoundId: 'spermidine',
    relatedSynergySlugs: [],
    outline: [
      'Overview & polyamine biology',
      'Mechanism: EP300 → autophagy',
      'Evidence summary (Madeo RCT, epidemiology)',
      'Dosing protocol & dietary sources',
      'Monitoring: cognition, fasting markers',
      'Safety & interactions',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'spermidine',
  },
  {
    ...
    category: 'compounds',
    title: 'Taurine',
    tagline: 'Age-depleted osmolyte — mitochondrial and membrane stress buffer',
    summary:
      'Sulfur-containing amino acid that buffers mitochondrial and membrane stress. Blood levels fall sharply with age. Singh 2023 Science linked taurine deficiency to multiple aging hallmarks and extended lifespan in mice. 1-3 g/day.',
    evidenceTier: 'B',
    relatedHallmarkIds: ['mito', 'inflammation', 'senescence'],
    compoundId: 'taurine',
    relatedSynergySlugs: [],
    outline: [
      'Overview & age-related decline',
      'Mechanism: osmolyte + mitochondrial buffer',
      'Evidence summary (Singh 2023 Science)',
      'Dosing protocol',
      'Monitoring: energy, hs-CRP',
      'Safety & interactions',
      'Buyer guide & red flags',
    ],
    mdxSlug: 'taurine',
  },
  {
    ...
    tagline: 'Only RCT-proven mitophagy activator in humans',
    summary:
      'Only commercially available compound proven in a Phase 2 RCT to activate mitophagy in humans. At 1000 mg/day (Mitopure standardized), improved muscle strength and reduced fatigue in adults 65+. Selective clearance of damaged mitochondria.',
    evidenceTier: 'A',
    relatedHallmarkIds: ['mito', 'autophagy'],
    compoundId: 'urolithina',
    relatedSynergySlugs: ['nad-mito-stack'],
    outline: [
      'Overview & mitophagy mechanism',
      'Evidence summary (Phase 2 RCT)',
      'Dosing protocol & Mitopure form',
