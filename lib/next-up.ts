...
export const nextUpImprovements: NextUpItem[] = [
  ...
  // In progress
  {
    ...
    desc: 'Order at-home panels in-app with automatic result webhook — beyond manual partner export upload.',
    status: 'in_progress',
    sprint: 'Q4 2026',
  ...
  // Planned
  {
    ...
    desc: 'Server-side digest send without third-party webhook — requires Resend API key on deploy.',
    status: 'planned',
    sprint: 'Sprint 10',
    href: '/brief',
    tags: ['retention', 'api'],
