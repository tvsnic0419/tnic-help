...
/**
 * High-detail SVG for Genomic Instability hallmark.
 * Shows DNA damage, PARP activation, NAD+ consumption, and repair pathways.
 * Includes intervention points (NMN, NRF2, sleep).
 */
  ...
  return (
    <div className={`relative tnic-glass rounded-2xl p-5 overflow-hidden ${className}`}>
      ...
      <svg viewBox="0 0 420 200" className="w-full h-auto" aria-label="Genomic Instability: DNA damage, PARP, NAD+ consumption and repair pathways" role="img">
        ...
        {/* Damaged DNA section (highlighted) */}
        <g>
        ...
        <g>
          ...
          {interactive && (
            <circle cx="280" cy="75" r="28" fill="none" stroke={accentColor} strokeWidth="1.5" opacity="0.3">
              <animate attributeName="r" values="22;30;22" dur="2.5s" repeatCount="indefinite" />
            </circle>
          )}
        </g>

        {/* NAD+ Arrow (being consumed) */}
        ...
        <g>
          ...
          <rect x="365" y="90" width="35" height="4" rx="2" fill="#f59e0b" opacity="0.3" />
        </g>

        {/* Repair Arrow (NRF2 / NMN intervention) */}
        <g stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" opacity="0.9">
